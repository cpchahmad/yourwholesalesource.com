...
class AdminWebhookController extends Controller
{
    ...
    public function after_fullfiment_process(OrderFulfillment $new_fulfillment, $retailer_order, $data): void
    {
        ...
        $order_log->message = "A fulfillment named thatss" . $new_fulfillment->name . " has been processed successfully on " . date_create($new_fulfillment->created_at)->format('d M, Y h:i a');
