        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="block block-rounded block-mode-loading-oneui">
                    ...
                    <div class="block-content p-0 text-center">
                        <div class="pt-3" style="height: 360px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas class="js-chartjs-dashboard-earnings chartjs-render-monitor" style="display: block; width: 488px; height: 344px;" width="488" height="344"></canvas></div>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="block block-rounded block-mode-loading-oneui">
                    ...
                    <div class="block-content p-0 text-center">
                        <div class="pt-3" style="height: 360px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas class="js-chartjs-dashboard-sales chartjs-render-monitor" width="488" height="344" style="display: block; width: 488px; height: 344px;"></canvas></div>
                    </div>
                    <div class="block-content">
                        <div class="row items-push text-center py-3">
                            <div class="col-6 col-xl-3">
