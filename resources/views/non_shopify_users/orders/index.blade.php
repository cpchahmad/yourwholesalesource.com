    ...
    <div class="content">
        ...
        <div class="row" >
            <div class="col-md-12">
                ...
                <a target="_blank" href="{{asset('NewCSVOrderFormat.csv')}}" style="margin-right: 10px;margin-bottom: 10px;float: right" class="btn btn-sm btn-warning import_button">View Sample CSV</a>
