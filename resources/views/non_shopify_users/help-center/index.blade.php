                                ...
                                <table class="table table-hover table-borderless table-striped table-vcenter">
                                    ...
                                    @foreach($tickets as $index => $ticket)
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-w600"><a href="{{route('help-center.users.ticket.view',$ticket->id)}}">{{ $ticket->title }}</a></td>
                                            <td>
                                              {{$ticket->email}}
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group">
                                                    <a href="{{route('help-center.users.ticket.view',$ticket->id)}}"
                                                    ...
                                                    @if($ticket->order_id !== null)
                                                        <button onclick="window.location.href='{{route('users.order.view',$ticket->order_id)}}'"
