...
@section('content')
    ...
    <div class="content">
        <form class="js-form-icon-search push" action="{{route('users.product.wefulfill')}}" method="get">
            ...
            @foreach($categories as $index => $category)
                @if($index < 11)
                    <div class="col-md-3 p-0 tooltip-ex">
                        <span class="tooltip-ex-text bg-info ml-5">
                            <a style="" href="https://fundraisingforacause.com/pages/ribbon-color-meanings" class="text-white" target="_blank">Ribbon meaning?</a>
                        </span>
                ...
                @if($index >= 11)
                    <div class="col-md-3 p-0 after12 tooltip-ex" style="display: none" >
                        <span class="tooltip-ex-text bg-info ml-5">
                            <a style="" href="https://fundraisingforacause.com/pages/ribbon-color-meanings" class="text-white" target="_blank">Click here to know what each ribbon means!</a>
                        </span>
                        ...
                        <div class="block">
                            ...
                            <div class="block-content" style="padding-bottom: 10px">
                                <div class="push-10">
                                    ...
                                    <div class="">
                                        <div class="font-w400 text-success mt-1">
                                            Cost Price
                                        ...
                                        <div class="font-400 text-primary mt-1 push-10-l" style="margin-left: auto">Shipping Price {{$product->new_shipping_price}}</div>
                                    </div>
                                </div>
