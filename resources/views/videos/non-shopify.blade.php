...
@section('content')
    ...
    <div class="content">
        ...
        <div class="block text-center pt-3">
            <h1 class="text-primary">Shopify Users</h1>
            <div class="row p-3">
                <div class="col-lg-4 invisible" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
                    <a class="block block-link-pop text-center p-2" href="https://www.youtube.com/watch?v=3TJkjf_R5hU" target="_blank">
                        ...
                        <div class="block-content text-left pl-0 d-flex justify-content-between">
                            <h4 class="mb-1">How to install WeFullFill App?</h4>
                ...
                <div class="col-lg-4 invisible" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
                    <a class="block block-link-pop text-center p-2" href="https://www.youtube.com/watch?v=aQovcXFZlfM" target="_blank">
                        <div class="overlay justify-content-center d-flex justify-content-center align-items-center" alt="">
                            <i class="si si-control-play text-white" style="font-size: 60px; font-weight: bolder;"></i>
                        </div>
                        <div class="block-content text-left pl-0 d-flex justify-content-between">
                            <h4 class="mb-1">How to connect with shopify store?</h4>
                            <div class="text-right">
                                <i class="si si-control-play text-white bg-dark p-2" style="font-size: 20px; font-weight: bolder; border-radius: 50%"></i>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 invisible" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
                    <a class="block block-link-pop text-center p-2" href="https://www.youtube.com/watch?v=JGFi_XyIoyI" target="_blank">
                        <div class="overlay justify-content-center d-flex justify-content-center align-items-center" alt="">
                            <i class="si si-control-play text-white" style="font-size: 60px; font-weight: bolder;"></i>
                        </div>
                        <div class="block-content text-left pl-0 d-flex justify-content-between">
                            <h4 class="mb-1">How to import a product and edit?</h4>
                            <div class="text-right">
                                <i class="si si-control-play text-white bg-dark p-2" style="font-size: 20px; font-weight: bolder; border-radius: 50%"></i>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 invisible" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
                    <a class="block block-link-pop text-center p-2" href="https://www.youtube.com/watch?v=cqcwyzAKGO0" target="_blank">
                        <div class="overlay justify-content-center d-flex justify-content-center align-items-center" alt="">
                            <i class="si si-control-play text-white" style="font-size: 60px; font-weight: bolder;"></i>
                        </div>
                        <div class="block-content text-left pl-0 d-flex justify-content-between">
                            <h4 class="mb-1">How to place order through wefullfill app?</h4>
                            <div class="text-right">
                                <i class="si si-control-play text-white bg-dark p-2" style="font-size: 20px; font-weight: bolder; border-radius: 50%"></i>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 invisible" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
                    <a class="block block-link-pop text-center p-2" href="https://youtu.be/NGdJkTKty0Q" target="_blank">
                        <div class="overlay justify-content-center d-flex justify-content-center align-items-center" alt="">
                            <i class="si si-control-play text-white" style="font-size: 60px; font-weight: bolder;"></i>
                        </div>
                        <div class="block-content text-left pl-0 d-flex justify-content-between">
                            <h4 class="mb-1">How to Track?</h4>
                            <div class="text-right">
                                <i class="si si-control-play text-white bg-dark p-2" style="font-size: 20px; font-weight: bolder; border-radius: 50%"></i>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 invisible" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
                    <a class="block block-link-pop text-center p-2" href="https://www.youtube.com/watch?v=7khMCbyaXN4" target="_blank">
                        <div class="overlay justify-content-center d-flex justify-content-center align-items-center" alt="">
                            <i class="si si-control-play text-white" style="font-size: 60px; font-weight: bolder;"></i>
                        </div>
                        <div class="block-content text-left pl-0 d-flex justify-content-between">
                            <h4 class="mb-1">How Shopify users start dropshipping business with WeFullfill</h4>
                            <div class="text-right">
                                <i class="si si-control-play text-white bg-dark p-2" style="font-size: 20px; font-weight: bolder; border-radius: 50%"></i>
                            </div>
                        </div>
