                                    ...
                                    <div class="tab-pane active" id="product_{{$product->id}}_products" role="tabpanel">
                                        <div class="block">
                                            <div class="options-container">
                                                <a href="{{route('store.product.wefulfill.show',$product->linked_product_id)}}">
                                            ...
                                            <div class="block-content" style="padding-bottom: 10px">
                                                <div class="push-10">
                                                    <a class="h6" href="{{route('store.product.wefulfill.show',$product->linked_product_id)}}">{{$product->title}}</a>
