        ...
        <div class="row">
            <div class="col-md-9">
                                        ...
                                        @if($item->has_associated_warehouse())
                                            <td>
                                                <select name="warehouse" id="" class="form-control warehouse-selector">
                                                    <option type="text" selected value="3{{ ','. $item->linked_product->linked_product->id . ','. $order->id }}">Default Warehouse</option>
                ...
                <div class="block">
                    ...
                    <div class="block-content default-warehouse" style="display: none;">
                        Hi
                    ...
                    <div class="block-content normal-warehouse">
                        @if($order->isShippable())
                            <table class="table table-borderless table-vcenter">
                                <thead>
                                </thead>
