...
{{--                                        {{number_format($order->shipping_price,2)}} USD--}}
    ...
    {{--                                        <button class="btn btn-success" data-toggle="modal" data-target="#payment_modal"><i class="fa fa-credit-card"></i> Credit Card Pay</button>--}}
                                            ...
                                            <button class="btn btn-success wallet-pay-button" data-href="{{route('store.order.wallet.pay',$order->id)}}" data-pay=" {{number_format($order->subtotal_price + $order->shipping_rate - $total_discount,2)}} USD" ><i class="fa fa-wallet"></i> Wallet Pay</button>
