                            ...
                            <table class="table table-hover table-borderless table-striped table-vcenter">
                                ...
                                @foreach($refunds as $index => $refund)
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-w600"><a href="{{route('store.order.view',$refund->has_order->id)}}">{{ $refund->title }}</a></td>
                                        <td>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                <button onclick="window.location.href='{{route('store.refund',$refund->id)}}'"
