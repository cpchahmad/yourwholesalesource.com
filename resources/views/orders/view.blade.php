                                        ...
                                        <td>
                                            @if($order->custom == 0)
                                                @if($item->linked_variant != null)
                                                    <p>{{asset('images/variants')}}/{{$item->linked_variant->has_image->image}}</p>
                                                    <img class="img-avatar"
                                                         ...
                                                         @else @if($item->linked_variant->has_image->isV == 1)
                                                                    @if({{$item->linked_variant->has_image->image}})
                                                                    @else
                                                                    @endif
                                                                    src="{{asset('images/variants')}}/{{$item->linked_variant->has_image->image}}"
                                                               @else src="{{asset('images')}}/{{$item->linked_variant->has_image->image}}"
                                                               @endif
                                                         @endif alt="">
                                                @else
