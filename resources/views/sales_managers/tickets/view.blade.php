    ...
    <div class="content">
        <div class="row">
            <div class="col-md-8">
                        ...
                        <div class="block">
                            <div class="block-header">
                                ...
                                @elseif($thread->source == 'store')
                                    <h5 class="block-title">{{explode('.',$ticket->has_store->shopify_domain)[0]}} (Source) <span class="badge badge-primary " style="float: right;font-size: small"> {{date_create($thread->created_at)->format('m d, Y h:i a')}}</span></h5>
                                @else
                ...
                <div class="block">
                    <div class="block-header">
                        <h5 class="block-title">Reply To Source</h5>
                    </div>
                    <div class="block-content">
                        <div class="p-2">
