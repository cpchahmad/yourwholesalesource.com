                                ...
                                <div class="email-content-detail" style="margin: 50px 0;">
                                    ...
                                    @if($template->id == '18')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="time" class="js-flatpickr form-control bg-white js-flatpickr-enabled flatpickr-input" id="example-flatpickr-datetime-24" name="example-flatpickr-datetime-24" data-enable-time="true" data-time_24hr="true" readonly="readonly">
                                            </div>
                                        </div>
