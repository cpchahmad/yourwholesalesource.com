            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        ...
                        <a class="btn btn-danger" href="{{route('refunds.index')}}"> <i class="fa fa-times"></i> Clear </a>
                    </div>
                </div>
            </div>
        </form>
                            ...
                            <table class="table table-hover table-borderless table-striped table-vcenter">
                                ...
                                @foreach($tickets as $index => $refund)
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-w600"><a href="{{route('refunds.view',$refund->id)}}">{{ $refund->title }}</a></td>
                                        <td>
                                        ...
                                        <td>
                                            @if($refund->has_order->status == 'paid')
                                                <span class="badge badge-primary" style="float: right;font-size: medium"> {{$refund->has_order->status}}</span>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                <button onclick="window.location.href='{{route('refunds.view',$refund->id)}}'"
