                                            ...
                                            @foreach($wallet->requests as $index => $req)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if($req->status == 0)
                                                        <button class="btn btn-sm btn-success approve-bank-transfer-button" data-route="{{route('admin.wallets.approve.request',$req->id)}}" data-wallet="{{$wallet->wallet_token}}" data-amount="{{number_format($req->amount,2)}} USD"> Approve Bank Transfer</button>
                                                        @endif
                                                    </td>
                                                </tr>
                                                </tbody>
