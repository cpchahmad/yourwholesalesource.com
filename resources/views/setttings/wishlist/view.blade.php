                            ...
                            <div class="p-2">
                                <form action="{{route('wishlist.thread.create')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="custom-control d-inline-block mb-2">
                                        <input type="checkbox" name="show_flag" class="custom-control-input category_checkbox" id="flag">
                ...
                @if($wishlist->has_product != null)
                    <div class="block">
                        ...
                        <div class="options-container">
                            ...
                            <div class="options-overlay bg-black-75">
                                <div class="options-overlay-content">
                                    <div class="push-20">
                                        <a class="btn btn-sm btn-primary" href="{{route('product.view',$wishlist->has_product->id)}}">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="block-content" style="padding-bottom: 10px">
                            <div class="push-10">
                                <a class="h6" style="font-size: 0.9rem" href="{{route('product.view',$wishlist->has_product->id)}}">{{$wishlist->has_product->title}}</a>
