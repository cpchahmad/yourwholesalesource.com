                                                                ...
                                                                @foreach($countries as $country)
                                                                    <div class="col-md-12">
                                                                        <div class="custom-control custom-checkbox d-inline-block">
                                                                            <input type="checkbox" name="countries[]"  @if(in_array($country->id,$zone->has_countries->pluck('id')->toArray())) checked @endif value="{{$country->id}}" class="custom-control-input" id="rowedit_{{$country->name}}">
                                                                            <label class="custom-control-label"  for="rowedit_{{$country->name}}">{{$country->name}}</label>
                                                                        </div>
                                                                    </div>
                        ...
                        <div class="block-content font-size-sm">
                            ...
                            <div class="countries-section">
                                @foreach($countries as $country)
                                    <div class="col-md-12">
                                        <div class="custom-control custom-checkbox d-inline-block">
                                            <input type="checkbox" name="countries[]" value="{{$country->id}}" class="custom-control-input" id="row_{{$country->name}}">
                                            <label class="custom-control-label" for="row_{{$country->name}}">{{$country->name}}</label>
                                        </div>
                                    </div>
