        ...
        <div class="row">
            <div class="col-md-8">
                ...
                @if(in_array($ticket->status_id,[5]))
                    <div class="text-right mb2">
                        <button class="btn btn-dark" onclick="window.location.href='{{route('help-center.ticket.marked_as_closed',$ticket->id)}}?manager_id={{$ticket->manager_id}}'"> Marked as Closed </button>
                    </div>
                @endif
                    @if($ticket->review == 1)
                        <div class="text-right mb2">
