...
<html>
<head>
    <title>WeFullFill Wishlist Complete</title>
</head>
<body style="margin: 0">
<style>
    .email-body
    ...
    <div class="email-contaner" style="border: 2px solid #7daa40;padding: 25px;">
        <div class="email-content" style="margin: auto;  text-align: center; ">
            ...
            <div class="email-content-detail" style="margin: 50px 0;">
                ...
                <a href="{{ route('store.wishlist.view', $wishlist->id) }}" target="_blank" class="email_btn" style="padding: 17px 55px; border: 2px solid #7daa40;font-size: 20px;letter-spacing: 1px;text-decoration: none;color: #7daa40;margin-top: 0;FONT-WEIGHT: 600;margin-bottom: 25px;margin-top: 25px">View Details</a>
            </div>
        </div>
    </div>
</div>
