                                                    ...
                                                    <tr>
                                                        <td align="center" valign="middle">
                                                            <a href="#" style="color:#ffffff;text-decoration:none;">
                                                                <img src="{{ asset('assets/colored.png') }}g" alt="150x50" width="150"/>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                                                                ...
                                                                                                <table align="center" border="0" cellspacing="0" cellpadding="0" class="display-width" width="100%" style="width:auto !important; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td align="left" valign="middle" class="MsoNormal padding-right" style="color:#FFFFFF;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:13px;font-weight:600;letter-spacing:1px;text-transform:capitalize;">
                                                                                                            info@awarenessdropshipping.com
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                            ...
                                            <td align="left" width="600">
                                                @if(count($product->has_images) > 0)
                                                    @foreach($product->has_images()->orderBy('position')->get() as $index => $image)
                                                        @if($index == 0)
                                                            @if($image->isV == 0)
                                                                <img src="{{asset('images')}}/{{$image->image}}" alt="540x250" width="540" style="border-radius:5px;color:#444444;width:100%;"/>
                                                            @else
                                                                <img src="{{asset('images/variants')}}/{{$image->image}}" alt="540x250" width="540" style="border-radius:5px;color:#444444;width:100%;"/>
                                                            @endif
                                                        @endif
                                                    @endforeach
                                                @else
                                                    <img src="https://wfpl.org/wp-content/plugins/lightbox/images/No-image-found.jpg" alt="540x250" width="540" style="border-radius:5px;color:#444444;width:100%;"/>
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <table align="center" bgcolor="#66b7e8" border="0" cellspacing="0" cellpadding="0" class="display-button" style="border-radius:5px;"> <!-- USING TABLE AS BUTTON -->
                                                    <tr>
                                                        <td align="center" valign="middle" class="MsoNormal" style="color:#ffffff;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:13px;font-weight:bold;letter-spacing:1px;padding:7px 15px;text-transform:uppercase;">
                                                            <a href="{{ route('store.my_products') }}" style="color:#ffffff;text-decoration:none;">View Details</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
