    ...
    <div class="email-contaner" style="border: 2px solid #66b7e8;padding: 25px;">
        <div class="email-content" style="margin: auto;  text-align: center; ">
            <div class="email-logo">
                <img src="{{ asset('assets/colored.png') }}" alt="Wefullfill" style="width: 35%">
            </div>
...
<div class="email-footer" style=" padding: 25px 10px; color: white; ">
    ...
    <div class="email-footer-caption">
        <ul style=" color: white; list-style: none; padding: 0 ;  margin-top: 25px;text-align: center; ">
            <li class="site-name" style="width: max-content; display: inline-block; margin-right: 15px;padding-right: 15px;border-right: 1px solid white;"><a href="" style="color: white;text-decoration: none;">Awareness Dropshipping</a></li>
