...
<head>
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width:640px) {
            ...
            table[class=display-width-menu1] {
                width:40% !important;
            }
        ...
        @media only screen and (max-width:320px) {
            ...
            .resp-padding{padding:0 15px !important;}
                                    ...
                                    <table align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" class="display-width" style="border-top-left-radius:5px;border-top-right-radius:5px;" width="600">
                                        ...
                                        <tr>
                                            <td class="resp-padding" style="padding:0 30px;">
                                                <!--TABLE LEFT-->
                                                <table align="left" border="0" cellspacing="0" cellpadding="0" class="display-width-menu1" width="60%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                                    <tbody>
                                                    <tr>
                                                        <td align="left" class="MsoNormal" style="color:#333333;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:20px;font-weight:600;letter-spacing:1px;line-height:15px;">
                                                            {{ $template->subject }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <!--TABLE RIGHT-->
                                                <table align="right" border="0" cellspacing="0" cellpadding="0" class="display-width-1" width="25%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                                    <tbody>
                                                    <tr>
                            ...
                            <tr>
                                <td align="center" class="resp-padding" style="padding:0 30px;">
                                    <table align="center"  border="0" cellpadding="0" cellspacing="0" class="display-width" width="100%">
                                        ...
                                        <tr>
                                            <td align="left" class="MsoNormal" style="color:#333333;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:14px;letter-spacing:1px;line-height:18px;">
                                                We Are pleased to confirm our purchase of the following items:
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30"></td>
                                                    ...
                                                    <tr>
                                                        <td width="600">
                                                            <table align="left" border="0" cellpadding="0" cellspacing="0" class="display-width" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                                                <tr>
                                                                    <td align="center" height="50" bgcolor="#66b7e8">
                                                                        <table align="left" border="0" cellpadding="0" cellspacing="0" class="display-width" width="100%">
                                                                            <tr>
                                                                                <td width="20" class="product-width"></td>
                                                                                <td align="left" width="250" class="MsoNormal product title-width-1" style="color:#ffffff;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:15px;font-weight:600;letter-spacing:1px;line-height:18px;text-transform:uppercase;">
                                                                                    Product
                                                                                </td>
                                                                                <td width="20" class="product-width"></td>
                                                                                                                ...
                                                                                                                @if($item->linked_product != null)
                                                                                                                    @if(count($item->linked_product->has_images)>0)
                                                                                                                        @if($item->linked_product->has_images[0]->isV == 1)
                                                                                                                            <img
                                                                                                                                src="{{asset('images/variants')}}/{{$item->linked_product->has_images[0]->image}}"  alt="60x60x1" width="60">
                                                                                                                        @else
                                                                                                                            <img
                                                                                                                                src="{{asset('images')}}/{{$item->linked_product->has_images[0]->image}}"  alt="60x60x1" width="60">
                                                                                                                        @endif
                                                                                                                    @else
                                                                                                                        <img
                                                                                                                            src="https://wfpl.org/wp-content/plugins/lightbox/images/No-image-found.jpg"  alt="60x60x1" width="60">
                                                                                                                    @endif
                                                                                                                @else
                                                                                                                    <img
                                                                                                                        src="https://wfpl.org/wp-content/plugins/lightbox/images/No-image-found.jpg"  alt="60x60x1" width="60">
                                                                                                        ...
                                                                                                        @else
                                                                                                            @if($item->linked_real_variant != null)
                                                                                                                <img
                                                                                                                    ...
                                                                                                                    @else @if($item->linked_real_variant->has_image->isV == 1) src="{{asset('images/variants')}}/{{$item->linked_real_variant->has_image->image}}" @else src="{{asset('images')}}/{{$item->linked_real_variant->has_image->image}}" @endif @endif  alt="60x60x1" width="60">
                                                                                                            @else
                                                                                                                @if($item->linked_real_product != null)
                                                                                                                    @if(count($item->linked_real_product->has_images)>0)
                                                                                                                        @if($item->linked_real_product->has_images[0]->isV == 1)
                                                                                                                            <img
                                                                                                                                src="{{asset('images/variants')}}/{{$item->linked_real_product->has_images[0]->image}}"  alt="60x60x1" width="60">
                                                                                                                        @else
                                                                                                                            <img
                                                                                                                                src="{{asset('images')}}/{{$item->linked_real_product->has_images[0]->image}}"  alt="60x60x1" width="60">
                                                                                                                        @endif
                                                                                                                    @else
                                                                                                                        <img c
                                                                                                                             src="https://wfpl.org/wp-content/plugins/lightbox/images/No-image-found.jpg"  alt="60x60x1" width="60">
                                                                                    ...
                                                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="display-width" width="100%" style="width:auto !important;">
                                                                                        <tr>
                                                                                            <td align="center" class="MsoNormal" style="color:#FFFFFF;font-family:'Segoe UI',sans-serif,Arial,Helvetica,Lato;font-size:14px;letter-spacing:1px;line-height:24px;">
                                                                                                Copyright &copy; 2021, Awareness Dropshipping
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
