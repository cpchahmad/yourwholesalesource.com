        ...
        <div class="email-content" style=" max-width: 450px;  margin: auto;  text-align: center; ">
            ...
            @isset($edit)
                <div class="email-content-detail" style="margin: 50px 0;">
                    ...
                    <br>
                    <input type="text" name="body" placeholder="Hey {{ $user->name }}, Welcome to Wefullfill Family, here you enjoy handsfree dropshipping and other perks." value="Hey {{ $user->name }}, Welcome to Wefullfill Family, here you enjoy handsfree dropshipping and other perks.">
{{--                    <p class="email-message-1" style=" margin: 0;margin-bottom: 30px;font-size: 20px;line-height: 1.53;" > </p>--}}
