            ...
            @isset($edit)
                <form action="{{ route('admin.emails.update', 1) }}" method="POST">
                    ...
                    <div class="email-content-detail" style="margin: 50px 0;">
                        <input class="email-title " type="text" name="subject" style="margin: 0;margin-bottom: 30px;font-size: 34px; width: 100%" placeholder="subject" value="Welcome to Wefullfill">
                        <br>
                        <textarea type="text" class="email-message-1" rows="5" style=" margin: 0;margin-bottom: 30px;font-size: 20px;line-height: 1.53; width: 100%" name="body" placeholder="body" >Hey {{ $user->name }}, Welcome to Wefullfill Family, here you enjoy handsfree dropshipping and other perks.</textarea>
                        <br>
