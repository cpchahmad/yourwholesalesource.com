...
Route::group(['middleware' => ['auth.shop','super-admin-store']], function () {
    ...
    Route::any('/products/{id}/update','ProductController@updateExistingProductNewVariants')->name('product.update.add.new.variants');
    Route::any('/products/{id}/update','ProductController@updateExistingProductOldVariants')->name('product.update.old.variants');
